...
class YOLOTrainer:
    def __init__(self, data_yaml, model_path, output_dir):
        ...
        self.hyperparameters = {
            "optimizer": "AdamW",
            "lr0": 0.00035102029551522894,
            "lrf": 0.1094288256799788,
            "batch_size": 16,
            "imgsz": 640,
            "epochs": 100,
            "weight_decay": 0.00011276414391911621,
            "momentum": 0.9,
            "warmup_epochs": 1.1408480794267375,
            "mosaic": 0.5,
            "mixup": 0.0313948691388259,
            "hsv_h": 0.014757621664803778,
            "hsv_s": 0.36673223861345616,
            "hsv_v": 0.1325519278584451,
            "fliplr": 0.0,
            "flipud": 0.0,
            "copy_paste": 0.5,
            "box": 0.042248820099610486,
            "cls": 0.5400973010594732,
            "dfl": 0.7481239938064271
        }
...
def main():
    DATA_YAML = r"/home/sailesh/RoadVehiclesYOLODatasetPro/data.yaml"
    YOLO_MODEL = r"/home/sailesh/yolo11m.pt"
    OUTPUT_DIR = r"/home/sailesh/RoadVehiclesYOLODatasetPro_TrainingOutput"
